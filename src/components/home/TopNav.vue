...
<template>
  <div class="topNav">
    <div class="topleft">
      <Icon icon="material-symbols-light:menu" class="w-[10vw] h-[10vw]" />
      <div class="searchTop">
        <Icon
          id="searchicon"
