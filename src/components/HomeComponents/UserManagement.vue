      ...
      <div class="upper-property">
        ...
        <div class="user-level">
          ...
          <div class="level">
            ...
            >
              <svg class="icon" aria-hidden="true" style="font-size: 1.39vw">
        ...
        <div class="user-xx">
          ...
          <div
            ...
            "
          >
            <span @click="toPage('my_good_friend')">
              {{ userProperty.getUserFollows.follow.length }} 关注</span
            >
            <span @click="toPage('my_good_friend')"
          ...
          <div class="user-xx-a">
            <span
              @click="toPage('my_songList')"
              v-if="userProperty.getUserSubcount.createdPlaylistCount"
            >
              {{ userProperty.getUserSubcount.createdPlaylistCount }} 歌单
            </span>
            <span
              @click="toPage('my_songList')"
              v-if="userProperty.getUserSubcount.subPlaylistCount"
            >
...
.UserManagement {
  ...
  .upper {
    ...
    .user-img {
      ...
      box-shadow: 0.21vw 0.21vw 0.63vw black;
      margin: 1.39vw 0;
    }
    .upper-property {
      display: flex;
      ...
      .user-xx {
        ...
        .user-xx-a {
          ...
          color: #555;
          span {
            border-bottom: 0.069vw solid #999;
